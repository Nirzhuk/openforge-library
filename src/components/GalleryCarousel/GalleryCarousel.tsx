...
export const PrevButton = ({ enabled, onClick }: ButtonProps) => (
    <button
        ...
        disabled={!enabled}
    >
        <svg className="embla__button__svg fill-current text-white" viewBox="137.718 -1.001 366.563 644">
...
export const NextButton = ({ enabled, onClick }: ButtonProps) => (
    <button
        ...
        disabled={!enabled}
    >
        <svg className="embla__button__svg fill-current text-white" viewBox="0 0 238.003 238.003">
